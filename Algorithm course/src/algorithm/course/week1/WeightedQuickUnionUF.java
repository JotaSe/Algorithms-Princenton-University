 ...
 */
/**
 * The <tt>WeightedQuickUnionUF</tt> class represents a union-find data
 * structure. It supports the <em>union</em> and <em>find</em> operations, along
 * with methods for determinig whether two objects are in the same component and
 ...
 * href="http://algs4.cs.princeton.edu/15uf">Section 1.5</a> of
...
public class WeightedQuickUnionUF {
    ...
    public static void main(String[] args) {
        ...
        uf.setUnions("3-7 6-2 1-8 8-9 3-6 1-4 0-9 5-1 0-6");
        uf.print();
